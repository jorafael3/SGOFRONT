...
@Component({
  selector: 'app-despachar-facturas',
  imports: [CommonModule, FormsModule, CardComponent, TableComponent],
  templateUrl: './despachar-facturas.component.html',
  styleUrl: './despachar-facturas.component.scss'
})
export class DespacharFacturasComponent {
